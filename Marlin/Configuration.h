...
#define STRING_CONFIG_H_AUTHOR "(Landon Snell, SKR-1.3 A8 config)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define DEFAULT_Kp 15.52  //21.0
  #define DEFAULT_Ki 0.70   //1.25
  #define DEFAULT_Kd 85.45  //86.0
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Anet A8, stock 12v 20A power supply, 4mm glass.
  //HVAC tape below bed, 6mm cork insulation, 
  //foil tape under insulation and around sides.
  #define DEFAULT_bedKp 303.56
  #define DEFAULT_bedKi 32.68
  #define DEFAULT_bedKd 704.98
 ...
 */
  ...
  #define DEFAULT_XJERK 20  //10.0
  #define DEFAULT_YJERK 20  //10.0
...
#define DEBUG_LEVELING_FEATURE
  ...
  //TODO: Convert these to calc's using the above
  #define LEFT_PROBE_BED_POSITION 35
  #define RIGHT_PROBE_BED_POSITION 200
  #define FRONT_PROBE_BED_POSITION 20 //15?
  #define BACK_PROBE_BED_POSITION 180 //150-180
 ...
 */
//TODO: LCD needs to be fixed before this can function
 ...
 */
//TODO: This may or may not fix SD
